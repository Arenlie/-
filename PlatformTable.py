...
def output_template(parm_data, bearing_data):
    ...
    if point_code[-2:-1] not in ['X', 'Y', 'Z']:
        if sensor_type == '应力波':
            ...
            Current_RMS, Current_PK, Current_CF, Current_Power_RMS, Current_THDF, Current_Odd_THD, Current_Even_THD, Current_Pos_THD, Current_Neg_THD, Current_Zero_THD, Current_Total_THD = [
                                                                                                                                                                                                 'v'] * 11
        elif sensor_type == '电压谱':
            Voltage_RMS, Voltage_PK, Voltage_CF, Voltage_Power_RMS, Voltage_THDF, Voltage_Odd_THD, Voltage_Even_THD, Voltage_Pos_THD, Voltage_Neg_THD, Voltage_Zero_THD, Voltage_Total_THD = [
                                                                                                                                                                                                 'v'] * 11
